...
Zusätzlich: nach dem ersten klick, also wenn "chat starten bestätigen" eingeblendet wird, wird mir ein prompt in die zwischenablage kopiert. und zwar der technisch korrekte begriff um diese Notiz Textbox zu referenzieren. Warum: damit ich in eine bereits bestehende Session mit diesem prompt, den pfad / den korrekten bezugspunkt / referenz mitteilen kann. 

erkläre mir das in deinen woten
